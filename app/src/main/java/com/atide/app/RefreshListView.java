 ...
 * @date: 2016/3/15.
 */
public class RefreshListView extends Activity implements XListView.IXListViewListener{
    ...
    public void onRefresh() {
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                items.clear();
                geneItems();
                mAdapter = new ArrayAdapter<String>(RefreshListView.this, R.layout.vw_list_item,
                        items);
                mListView.setAdapter(mAdapter);
                onLoad();
            }
